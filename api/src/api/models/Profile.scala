...
object RiskProfile:
    given Encoder[RiskProfile] = Encoder.encodeString.contramap[RiskProfile](_.value)
    ...
    def fromString(s: String): Option[RiskProfile] = RiskProfile.values.find(_.value == s)
...
object FireProfile:
    given Encoder[FireProfile] = Encoder.encodeString.contramap[FireProfile](_.value)
    ...
    def fromString(s: String): Option[FireProfile] = FireProfile.values.find(_.value == s)
