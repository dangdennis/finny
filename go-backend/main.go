...
type PlaidLinkNewOutput struct {
	Body struct {
		LinkToken string `json:"link_token"`
	}
}

type PlaidItemLinkOutput struct {
	Body struct {
...
func main() {
	...
	cli := humacli.New(func(hooks humacli.Hooks, options *Options) {
		...
		}) (*PlaidItemLinkOutput, error) {
			resp := &PlaidItemLinkOutput{}
