...
let PLAID_CATEGORIES: PlaidCategoryDict = [
  ...
  PlaidCategoryKey(category: "INCOME", subcategory: "INCOME_TAX_REFUND"): "Income from tax refunds",
  ...
  PlaidCategoryKey(category: "FOOD_AND_DRINK", subcategory: "FOOD_AND_DRINK_BEER_WINE_AND_LIQUOR"):
  ...
  PlaidCategoryKey(category: "FOOD_AND_DRINK", subcategory: "FOOD_AND_DRINK_OTHER_FOOD_AND_DRINK"):
    "Other miscellaneous food and drink, including desserts, juice bars, and delis",
  PlaidCategoryKey(
    category: "GENERAL_MERCHANDISE", subcategory: "GENERAL_MERCHANDISE_BOOKSTORES_AND_NEWSSTANDS"):
  ...
  PlaidCategoryKey(category: "GENERAL_MERCHANDISE", subcategory: "GENERAL_MERCHANDISE_ELECTRONICS"):
  ...
  PlaidCategoryKey(category: "GENERAL_MERCHANDISE", subcategory: "GENERAL_MERCHANDISE_SUPERSTORES"):
  ...
  PlaidCategoryKey(
    category: "GENERAL_SERVICES", subcategory: "GENERAL_SERVICES_ACCOUNTING_AND_FINANCIAL_PLANNING"):
  ...
  PlaidCategoryKey(category: "TRANSPORTATION", subcategory: "TRANSPORTATION_TAXIS_AND_RIDE_SHARES"):
    "Taxi and ride share services",
  PlaidCategoryKey(category: "TRANSPORTATION", subcategory: "TRANSPORTATION_TOLLS"):
    "Toll expenses",
  PlaidCategoryKey(category: "TRANSPORTATION", subcategory: "TRANSPORTATION_OTHER_TRANSPORTATION"):
  ...
  PlaidCategoryKey(category: "RENT_AND_UTILITIES", subcategory: "RENT_AND_UTILITIES_RENT"):
    "Rent payment",
  PlaidCategoryKey(
    category: "RENT_AND_UTILITIES", subcategory: "RENT_AND_UTILITIES_SEWAGE_AND_WASTE_MANAGEMENT"):
