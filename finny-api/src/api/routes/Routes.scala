...
object Routes:
  def createRoutes(
    ...
    val indexEndpoint = endpoint
      ...
      .get
      .out(stringBody)
      .handle(_ => IndexHandler.handleIndex())
    ...
    val usersDeleteServerEndpoint = usersDeleteRoute.handle(user =>
      input => UserHandler.handleUserDelete(user.id)
    )
    ...
    val plaidItemsCreateServerEndpoint = plaidItemsCreateRoute
      .handle(user =>
        input => PlaidItemHandler.handlePlaidItemsCreate(user, input)
      )
    ...
    val plaidItemsDeleteServerEndpoint = plaidItemsDeleteRoute
      .handle(user =>
        input => PlaidItemHandler.handlePlaidItemsDelete(user, input)
      )
    ...
    val plaidItemsSyncServerEndpoint = plaidItemsSyncRoute
      .handle(user =>
        input => PlaidItemHandler.handlePlaidItemsSync(user, input)
      )
    ...
    val powersyncEventUploadEndpoint = protectedApiRouteGroup.post
    ...
    val powersyncEventUploadServerEndpoint = powersyncEventUploadEndpoint
      .handle(profile =>
        input =>
          PowerSyncHandler.handleEventUpload(input = input, user = profile)
      )
    ...
    val all =
      serverEndpoints ++ docEndpoints ++ List(
        metricsEndpoint,
        webhooksEndpoint,
